...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      ...
      array(
        'id'          => 'form-popup',
        'label'       => 'Форма в попап окне',
        'desc'        => 'Вставьте шорткод',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header',
      ),
      array(
        'id'          => 'form-head',
        'label'       => 'Форма (гарантированая скидка)',
        'desc'        => 'Вставьте шорткод',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header',
	  ...
	  array(
        'id'          => 'sertificate',
        'label'       => 'Контент блока сертификаты',
        'desc'        => '',
        'type'        => 'tab',
        'section'     => 'home'
      ),
	  array(
        'id'          => 'form-sertificate',
        'label'       => 'Форма (Подарочные сертификаты)',
        'desc'        => 'Вставьте шорткод',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'home',
      ...
      array(
        'id'          => 'inst',
        'label'       => 'Инстаграм',
        'desc'        => 'Вставте абсолютный путь к вашей групе или аккаунту в соц. сети',
        'std'         => '',
        'type'        => 'text',
        'section'     => 'footer',
      ),
